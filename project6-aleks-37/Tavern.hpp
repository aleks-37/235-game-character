...
This program:
Tavern.hpp provides interface and declaration of private and public members of Tavern class
*/
...
*/
  ...
  void useBuffsHelp(Character* entity); //helper function for buff

  void detailsPrint(Character* current); //helper to print details

  void useBuff(Character* entity, const bool& player); //helper for buff
