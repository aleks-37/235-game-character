...
This program:
Character.hpp interface for functions of Character class
*/
...
*/
        ...
        void strike(Character* target) const;
...
*/
        ...
        std::stack<Buff>& getBuffStack(); //helper function to get the buffstack

        std::queue<int>& getActionQueue(); //helper function to get actionqueue

        void applyBuff(const Buff& buff); //helper function to help apply buff
